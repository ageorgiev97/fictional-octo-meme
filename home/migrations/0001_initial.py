    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64)),
                ('description', models.TextField(max_length=256)),
                ('lunch_start', models.TimeField(verbose_name='Lunch Start')),
                ('lunch_end', models.TimeField(verbose_name='Lunch End')),
                ('image', models.TextField(max_length=1024)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('allergen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Allergen')),
                ('dish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Restaurant')),
            ],
        ),
        migrations.CreateModel(
            name='Dish',
            fields=[
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=3, default=Decimal('0.0'), max_digits=6, validators=[djmoney.models.validators.MinMoneyValidator(0)])),
